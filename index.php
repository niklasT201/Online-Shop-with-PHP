...
<body>
  <div class="navbar">
    ...
    <a href="#" onclick="scrollToContact()"><i class="fa fa-fw fa-envelope"></i> Contact</a>
  ...
  <div class="navbar2">
    <a class="active" href="index.php"><i class="fa fa-fw fa-all"></i>All</a>
  ...
  <?php
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // Truncate description to a desired length and append "..." if it exceeds that length
            $truncatedDescription = strlen($row["description"]) > 100 ? substr($row["description"], 0, 100) . "..." : $row["description"];
  ...
  <div class="container" id="contact-form-container"> <!-- Added id attribute -->
